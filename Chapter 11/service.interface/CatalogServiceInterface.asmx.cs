...
namespace ServiceInterface
{
	...
	public class CatalogServiceInterface : System.Web.Services.WebService
	{
		...
		[WebMethod]
		public ReviewDto AddReview(string reviewerName, string content, int rating, 
			long recordingId)
		{
			...
			try
			{
				reviewDto = service.AddReview(reviewerName, content, rating, recordingId);
			}
			catch(ExistingReviewException exception)
			{
				throw SoapExceptionMapper.Write(exception);
			}
